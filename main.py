...
# Gemini Client ကို တည်ဆောက်ခြင်း
client = genai.Client(api_key=GEMINI_API_KEY)

# --- System Instruction (Akari - ဧကရီ Persona & Knowledge Base) ---
AKARI_INSTRUCTION = """
...
- Brand Name: Akari - ဧကရီ (အကာရီ - ဧကရီ)
...
- ပို့ဆောင်ရေး: Ninja Van ရှိသည့် မြို့တိုင်းကို အိမ်ရောက်ငွေချေ (COD) စနစ်ဖြင့် ပို့ဆောင်ပေးသည်။
